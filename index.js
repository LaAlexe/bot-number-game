...
const token = '1938084191:AAEpmukKQ9UDmNzWJHrvG15_2ukQwiH07wM';
 ...
 const start = () => {
     ...
     bot.on('message', async msg => {
         ...
         if (text === '/start'){
             ...
             return bot.sendMessage(chatId, `Добро пожаловать в number game`);
         }
     ...
     bot.on('callback_query', async msg => {
         ...
         if (data === chats[chatId]) {
             ...
             return await bot.sendMessage(chatId, `Не угадал, бот загадал цифру ${chats[chatId]}`, againOptions);
         }
